		...
		<div className={styles.container}>
				...
				<div className={styles.content}>
					<div className={styles.content__introduce}>
						<div className={styles['content__main-text']}>
							<span className={styles['content__main-text--name']}>
								Winection
							</span>{' '}
							으로 소통의 한계를 뛰어넘어 보세요.
						</div>
						<p className={styles.content__description}>
							Winection은 <span>양방향 수어 번역 화상채팅 서비스</span>로 온라인
							환경에서 농인들의 원활한 소통을 지원합니다.
							<br />
							<br />
							농인들에게는 목소리를 선물하고, 실제 목소리를 수어로 바꾸어
							보여주는 화상채팅 플랫폼,
							<br />
			...
			<div className={styles['button-container']}>
				<div className={styles['button-container__content']}>
					{breakPoint === 'mobile' && (
						<div className={styles['button-container__description']}>
							<span>기존 회원</span>이라면 여기!
						</div>
					)}
					<button
